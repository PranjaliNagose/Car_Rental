...
#Create rentals and to list
rentals.append({'rental_id':"R001",'customer':customers[0],'car':cars[0],'rental_fee':500.0})
rentals.append({'rental_id':"R001",'customer':customers[1],'car':cars[1],'rental_fee':450.0})
rentals.append({'rental_id':"R001",'customer':customers[2],'car':cars[2],'rental_fee':350.0})
